...
async function testDecrypt() {
  try {
    ...
    console.log('Header magic (first 4 bytes):', decrypted.subarray(0, 4).toString('utf8'), 'hex:', decrypted.subarray(0, 4).toString('hex'));
    
    // Check GLB magic number "glTF" -> 0x46546C67
